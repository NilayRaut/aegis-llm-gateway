...
def _build_seed_records() -> list[dict]:
    ...
    # Group 2: gemini-1.5-flash (10 records)
    ...
    for _ in range(12):
        records.append({
            ...
            "complexity_score": round(random.uniform(0.42, 0.58), 3),
            "domain": "general",
            "cache_hit": 0,
            "risk_level": "SAFE",
            "security_blocked": 0,
    ...
    for _ in range(5):
        records.append({
            "id": str(uuid.uuid4()),
            "timestamp": ts(idx),
            "model_used": "claude-haiku-3-5-sonnet-20241022",
            "provider": "anthropic",
            "cost_usd": round(random.uniform(0.000020, 0.000030), 8),
            "latency_ms": random.randint(800, 1500),
            "complexity_score": round(random.uniform(0.62, 0.78), 3),
            "domain": "general",
            "cache_hit": 0,
            "risk_level": "SAFE",
            "security_blocked": 0,
