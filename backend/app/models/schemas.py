...
class RoutingDecision(BaseModel):
    ...
    model: Literal["llama3.1", "llama-3.1-8b-instant", "gemini-2.0-flash", "gpt-4o-mini", "claude-haiku-4-5-20251001", "gpt-4o", "blocked", "error"] = Field(..., description="Which model was selected")
